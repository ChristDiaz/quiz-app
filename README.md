...
- `OPENAI_CROP_SELECTOR_VERSION` (optional, defaults to `v2`)
  - `v2`: enhanced selector (table-aware scoring + one-question promotion fallback)
  - `v1`: legacy selector (no question promotion, image-object-first for visual cue questions)
